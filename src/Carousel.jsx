...
  // Fetch slide data from API and get only the first 10
  useEffect(() => {
...
                                    type="button"
                                  >
                                    <picture className="mui-style-1qswh78-fullOpacity" style={{ display: "block", width: "100%", height: "250px", overflow: "hidden" }}>
                                     <source type="image/webp" srcSet={match.src} />
                                      ...
                                      style={{
                                       ...
                                       height: "100%",
                                       objectFit: "cover",
                                       objectPosition: "top center"  // crop from bottom side
                                         }}
                                        />
                                    </picture>
