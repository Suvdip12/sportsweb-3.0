function Header() {
  const navItems = [
    { label: 'For You', href: '/', icon: './src/assets/home-av.svg' },
    { label: 'Sports', href: '/live/StarSports.html', icon: './src/assets/cric_of.svg' },
        ...
        <div className="mui-style-1xnl3zj-webroot">
          <div className="mui-style-138c29f-headerMain">
            <div className="mui-style-3ir3rb-headerItems">
              <img src="./src/assets/logo.jpg" alt="ivy" style={{ height: '57px', cursor: 'pointer' }} />
